...
const NavBarUser = () => {
  ...
  return (
      ...
      <AppBar position="static" style={{backgroundColor: theme.palette.azul.color}}>
        ...
        {showLogoutModal && (
        <Grid container item xs={9} sm={6} md={4} lg={3} className="logout-modal"  style={{position: "fixed",top: "50%",left: "50%",transform: "translate(-50%, -50%)",backgroundColor: theme.palette.blanco.color,padding: "2em",borderRadius: "5px",color: "#ffffff",zIndex: "9999"}}>
